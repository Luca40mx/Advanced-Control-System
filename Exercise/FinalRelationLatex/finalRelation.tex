...
\subsection{$\tau$, with kinetic and potential energy}
...
\subsection{$\tau$ with Coriolis, centrifugal and gravity terms}
...
\begin{figure}[H]
    \centering
    \makebox[\textwidth][c]{\includegraphics[width=1.6\textwidth]{../Simulink/Images/gravity_compensation_joint_space.png}}
    \caption{PD control law with gravity compensation in joint space}
    \label{fig:gravity_compensation_joint_spacee}
\end{figure}
...
\begin{figure}[H]
    \centering
    \makebox[\textwidth][c]{\includegraphics[width=1.6\textwidth]{../Simulink/Images/inverse_dynamic_joint_space.png}}
    \caption{Inverse dynamic control law in joint space}
    \label{fig:inverse_dynamic_joint_space}
\end{figure}
...
\begin{figure}[H]
    \centering
    \makebox[\textwidth][c]{\includegraphics[width=1.6\textwidth]{../Simulink/Images/gravity_compensation_operational_space.png}}
    \caption{PD control law with gravity compensation in the operational space}
    \label{fig:gravity_compensation_operational_space}
\end{figure}
...
\begin{figure}
    \centering
    \makebox[\textwidth][c]{\includegraphics[width=1.6\textwidth]{../Simulink/Images/inverse_dynamic_operational_space.png}}
    \caption{Inverse dynamic control law in the operational space}
    \label{fig:inverse_dynamic_operational_space}
\end{figure}
...
\begin{figure}[H]
    \centering
    \makebox[\textwidth][c]{\includegraphics[width=1.6\textwidth]{../Simulink/Images/passive_compliance_control.png}}
    \caption{passive compliance control scheme}
    \label{fig:passive_compliance_control}
\end{figure}
...
Is super important to understand that the T matrix, is the transformation matrix from the end effector to the desired position, as reported in the matlab code below:
...
\begin{figure}[H]
    \centering
    \makebox[\textwidth][c]{\includegraphics[width=1.6\textwidth]{../Simulink/Images/active_compliance_control.png}}
    \caption{active compliance control scheme}
    \label{fig:active_compliance_control}
\end{figure}
...
\begin{figure}[H]
    \centering
    \makebox[\textwidth][c]{\includegraphics[width=1.2\textwidth]{../Simulink/Images/force_control_inner_position_loop.png}}
    \caption{force control inner position}
    \label{fig:force_control_inner_position_loop}
\end{figure}
...
\begin{figure}[H]
    \centering
    \makebox[\textwidth][c]{\includegraphics[width=1.2\textwidth]{../Simulink/Images/force_control_inner_velocity_loop.png}}
    \caption{force control inner velocity loop}
    \label{fig:force_control_inner_velocity_loop}
\end{figure}
...
\begin{figure}[H]
    \centering
    \makebox[\textwidth][c]{\includegraphics[width=1.2\textwidth]{../Simulink/Images/parallel_force_control.png}}
    \caption{parallel force/position control scheme}
